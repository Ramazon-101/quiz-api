...
from apps.accounts.api.v1.serializers import RegisterSerializer, LoginSerializer, UserUpdateSerializer, \
    AccountOwnImageUpdateSerializer, AccountUpdateSerializer, SetNewPasswordSerializer
...
class AccountView((generics.RetrieveAPIView)):
    ...
    def get(self, request, *args, **kwargs):
        ...
        serilazer = self.get_serializer(query)
        return Response({'Success': True, 'data': serilazer.data}, status=status.HTTP_200_OK)
